/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 12b7f91f5ed2ed79b8844f787de4be12)
...
interface __BaseEnv_Env {
	...
	SUBMISSIONS: DurableObjectNamespace<import("./src/index").ContactSubmission>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ContactSubmission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_ENABLED">> {}
}
