...
<style>
  ...
  .token { display: inline; min-height: 0; padding: 0; margin: 0; border: 0; border-radius: var(--radius-sm); background: transparent; box-shadow: none; font: inherit; white-space: pre-wrap; overflow-wrap: anywhere; }
