...
:mod:`drowse.core.instruments.protocol` carries the contract they share.
...
* **ScalarReading** is the honest reading shape for the single-channel
  ...
  carries the full :class:`~drowse.core.results.ProbeReading`.
...
#: whitened :class:`~drowse.core.results.ProbeReading`, or the single-axis
...
def as_probe_reading(reading: "Reading") -> "ProbeReading":
    ...
    ``x-drowse-probe-readings`` vendor extension, whose shape is a user
