...
class LoweredAffine:
    ...
    :class:`~drowse.core.manifold.SynthesizedSubspace` layer reduced to exactly
...
class SteeringManager:
    ...
    def add_manifold(
        ...
        :class:`drowse.core.manifold.UnknownManifoldLabelError`; arity
        mismatches against the manifold's domain (only meaningful for
        coord-form input) raise
        :class:`drowse.core.steering_expr.SteeringExprError`.
            ...
            for layer_idx, sub in manifold.layers.items():
                ...
                if prev is not None:
                    ...
                    if cross > _CURVED_ORTHO_TOL:
                        from drowse.core.errors import OverlappingManifoldError
