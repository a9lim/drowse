"""Per-call sampling configuration for DrowseSession.generate.
...
class SamplingConfig:
    ...
    # Loom-path knob for top-K alternatives capture (drowse-native; the
    ...
    # decoded text per :class:`TokenAlt`. The sampler bounds the count by
    # its actual candidate pool; retaining many alternatives costs memory.
    return_top_k: int = 0
