...
class SceneRenderError(DrowseError, RuntimeError):
...
class SceneThinkingUnsupportedError(DrowseError, ValueError):
...
def extract_turn_grammar(
    ...
    *,
    ...
    :class:`~drowse.core.scene.SceneThinkingUnsupportedError` fire on commit
