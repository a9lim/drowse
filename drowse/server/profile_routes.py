"""Native profiles route group (``/drowse/v1/sessions/{id}/profiles/*``).
...
from drowse.server.profile_models import (
    BakeProfileRequest,
    ExtractRequest,
...
def register_profile_routes(app: FastAPI) -> None:
    ...
    @app.get("/drowse/v1/sessions/{session_id}/profiles")
    ...
    @app.get("/drowse/v1/sessions/{session_id}/profiles/pairwise")
    ...
    @app.get("/drowse/v1/sessions/{session_id}/profiles/{name}")
    ...
    @app.get("/drowse/v1/sessions/{session_id}/correlation")
    ...
    @app.delete("/drowse/v1/sessions/{session_id}/profiles/{name}", status_code=204)
    ...
    @app.post(
        "/drowse/v1/sessions/{session_id}/extract",
    ...
    @app.post("/drowse/v1/sessions/{session_id}/profiles/bake")
    async def bake_profile(
        ...
        The HTTP face of :meth:`DrowseSession.bake`, which owns the whole
