"""Shared primitives for the native ``/drowse/v1`` route tree."""
...
def refuse_if_busy(session: "DrowseSession") -> None:
...
def extraction_error_frame(exc: Exception) -> dict[str, Any] | None:
    ...
    :class:`~drowse.core.extraction.ManifoldExtractionPipeline`, so they share
