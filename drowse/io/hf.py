"""Shared Hugging Face Hub primitives — the single HF seam for :mod:`drowse.io`.
...
distribution (:mod:`drowse.io.hf_manifolds`) and the external J-lens source
registry (:mod:`drowse.io.lens_sources`) both import them under these exact
