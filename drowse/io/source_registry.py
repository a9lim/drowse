...
Both families are *source registries*: Drowse owns what it fits or trains and
stores it under ``DROWSE_HOME``, external publishers keep their payloads in
their own caches and Drowse stores only a pinned binding, and one
...
class ActiveSourceRegistry:
    ...
    a name the family cannot address — a drowse-owned artifact validates
