...
SAE variants, so the rest of drowse (selectors, packs, monitor) sees a
...
from drowse.io.atomic import fsync_directory, write_bytes_atomic, write_json_atomic
from drowse.io.paths import model_dir, safe_model_id
...
class AlignmentError(ValueError, DrowseError):
