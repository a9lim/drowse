...
- Optional bearer auth via `--api-key` or `$DROWSE_API_KEY`. If unset, every HTTP
...
Drowse resolves Hugging Face configuration and tokenizer metadata with remote-code
